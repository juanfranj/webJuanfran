...
import numpy as np
import random
from core.registro.libs.pyclick._utils import isListOfPoints, isNumeric
from core.registro.libs.pyclick._beziercurve import BezierCurve
...
class HumanCurve():
    ...
    def generateCurve(self, **kwargs):
        ...
        """
        offsetBoundaryX = kwargs.get("offsetBoundaryX", 50)
        offsetBoundaryY = kwargs.get("offsetBoundaryY", 50)
        ...
        targetPoints = kwargs.get("targetPoints", 50)
